...
y_true = predictions.select("atg_code","label").orderBy("atg_code")
y_true = y_true.toPandas()
y_pred = predictions.select("atg_code","prediction").orderBy("atg_code")
...
y = predictions.select("atg_code","prediction","label","tag").orderBy("atg_code").toPandas()
