...
storage_account_name = "lcproject"
storage_account_access_key = "GW9n02UTbJUB3n+vUfcDhqtnSFO/4kn0d/ogIpY7oJ4IjvRSe1DhcmEXfufqynrcz2g/yvWyQZl7+AStAC4o+A=="

# COMMAND ----------

file_location = "wasbs://pickles@lcproject.blob.core.windows.net/"
file_type = "csv"
...
dbutils.fs.cp(file_location, "file:/pickle", recurse=True) # copy
